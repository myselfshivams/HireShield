...
const Pricing = () => {
  return (
    <>
      <section className="flex items-center justify-center pb-10 bg-white" id='pricing'>
        <div className="p-4 sm:px-10 flex flex-col justify-center items-center text-base h-100vh mx-auto">
          <h3 className="text-5xl font-semibold text-center flex gap-2 justify-center mb-10 text-black">Pricing</h3>
          <div className="isolate mx-auto grid max-w-md grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-2">
            <div className="ring-1 ring-gray-200 rounded-3xl p-8 xl:p-10">
              <div className="flex items-center justify-between gap-x-4">
                <h3 id="tier-standard" className="text-gray-900 text-2xl font-semibold leading-8">For Individuals</h3>
              </div>
              <p className="mt-4 text-base leading-6 text-gray-600">Explore the best areas for living based on quality-of-life factors tailored to your needs.</p>
              ...
              <ul role="list" className="mt-8 space-y-3 text-sm leading-6 text-gray-600 xl:mt-10">
                <li className="flex gap-x-3 text-base">
                  ...
                  </svg>Access to Basic Rankings
                </li>
                <li className="flex gap-x-3 text-base">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" aria-hidden="true" className="h-6 w-5 flex-none text-blue-600">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>Personalized Suggestions
                </li>
              </ul>
            </div>
            <div className="ring-2 ring-blue-600 rounded-3xl p-8 xl:p-10">
              <div className="flex items-center justify-between gap-x-4">
                <h3 id="tier-extended" className="text-blue-600 text-2xl font-semibold leading-8">For Real Estate Professionals</h3>
